...
mesh2_face_nodes = ds.createVariable('Mesh2_face_nodes', 'int32', dimensions=('nMesh2_face', 'nMaxMesh2_face_nodes'), fill_value=999999)
...
mesh2_face_edges = ds.createVariable('Mesh2_face_edges', 'int32', dimensions=('nMesh2_face', 'nMaxMesh2_face_nodes'), fill_value=999999)
...
mesh2_face_links = ds.createVariable('Mesh2_face_links', 'int32', dimensions=('nMesh2_face', 'nMaxMesh2_face_nodes'), fill_value=999999)
...
mesh2_edge_face_links = ds.createVariable('Mesh2_edge_face_links', 'int32', dimensions=('nMesh2_edge', 'two'), fill_value=-999)
...
mesh2_face_xbnds = ds.createVariable('Mesh2_face_xbnds', 'double', dimensions=('nMesh2_face', 'nMaxMesh2_face_nodes'), fill_value=9.9692099683868690E36)
...
mesh2_face_ybnds = ds.createVariable('Mesh2_face_ybnds', 'double', dimensions=('nMesh2_face', 'nMaxMesh2_face_nodes' ), fill_value=9.9692099683868690E36)
