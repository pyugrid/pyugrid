...
def test_build_face_face_connectivity2():
    ...
    #zeroth triangle should have one empty faces
    assert sum(face_face[0] == -1) == 1
    #zeroth triangle should have one neighbor: 2
    assert sum(face_face[0] == 2) == 1
    #zeroth triangle should have one neighbor: 3
    assert sum(face_face[0] == 3) == 1
